      ...
      <div className="flex flex-col mx-6 items-start justify-start pt-[160px] min-h-screen relative md:mx-12 xl:mx-20 2xl:mx-48 3xl:mx-96">
        ...
        {caseStudy.map((item, id) => (
          <a
            key={id}
            href={item.link}
            className="text-[51px] text-start text-[#CBB89D] uppercase  hover:text-[#6A6F4C] transition-colors duration-700 cursor-pointer md:text-6xl lg:text-8xl xl:text-[8rem] xl:font-bold"
          >
            {item.title}
